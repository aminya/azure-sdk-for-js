...
import { TokenCredential, AzureKeyCredential, KeyCredential, isTokenCredential } from "@azure/core-auth";
...
export class OpenAIClient {
    ...
    constructor(endpointOrOpenAiKey: string, credOrOptions: KeyCredential | TokenCredential | ClientOptions = {}, options: ClientOptions = {}) {
    ...
    getEmbeddings(deploymentOrModelName: string, input: string[], options?: GetEmbeddingsOptions): Promise<DeploymentEmbeddingsOptionsEmbeddings>;
    getEmbeddings(deploymentOrModelName: string, input: string | string[], options: GetEmbeddingsOptions = { requestOptions: {} }): Promise<DeploymentEmbeddingsOptionsEmbeddings> {
        this.setModel(deploymentOrModelName, options);
        return getEmbeddings(this._client, input, deploymentOrModelName, options);
    }

    getChatCompletions(deploymentOrModelName: string, messages: ChatMessage[], options: GetChatCompletionsOptions = { requestOptions: {} }): Promise<DeploymentChatCompletionsOptionsChatCompletions> {
        this.setModel(deploymentOrModelName, options);
    ...
    getCompletions(deploymentOrModelName: string, promptOrOptions?: string | string[] | GetCompletionsOptions, options: GetCompletionsOptions = { requestOptions: {} }): Promise<DeploymentCompletionsOptionsCompletions> {
        this.setModel(deploymentOrModelName, options);
        return getCompletions(this._client, deploymentOrModelName, promptOrOptions as any, options);
    }

    getCompletionsStreaming(deploymentOrModelName: string, prompt: string, options?: GetCompletionsOptions): AsyncIterable<string>;
    getCompletionsStreaming(deploymentOrModelName: string, prompt: string[], options?: GetCompletionsOptions): AsyncIterable<string>;
    getCompletionsStreaming(deploymentOrModelName: string, options?: GetCompletionsOptions): AsyncIterable<string>;
    getCompletionsStreaming(deploymentOrModelName: string, promptOrOptions?: string | string[] | GetCompletionsOptions, options: GetCompletionsOptions = { requestOptions: {} }): AsyncIterable<string> {
        this.setModel(deploymentOrModelName, options);
        const opts: GetCompletionsOptions = typeof promptOrOptions === "object" && !Array.isArray(promptOrOptions)
                                          ? promptOrOptions
